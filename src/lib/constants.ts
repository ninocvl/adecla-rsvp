...
// Categorías que se pueden elegir hoy. Femenina D se retiró del torneo; el
// valor sigue en el enum de la base y en las etiquetas de abajo para que una
// fila vieja se siga leyendo en vez de salir en blanco.
